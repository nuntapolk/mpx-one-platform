...
@Injectable()
export class RopaCampaignsService {
  constructor(@InjectRepository(RopaCampaign) private repo: Repository<RopaCampaign>) {}
  ...
  async findOne(id: string, orgId: string) {
    ...
    if (!item) throw new NotFoundException('RopaCampaign ' + id + ' not found')
    return item
  }
