...
@ApiTags('PDPA · ROPA Field Config')
@ApiBearerAuth()
@UseGuards(KeycloakGuard)
@Controller('api/v1/ropa-field-configs')
export class RopaFieldConfigController {
  constructor(private readonly svc: RopaFieldConfigService) {}
