...
export class AddReadiness1782485620028 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_72cb339021ba0a9191ea21dc27" ON "regions" ("tenant_id", "code") `);
        await queryRunner.query(`CREATE TABLE "module_scores" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "score_snapshot_id" uuid NOT NULL, "module_code" character varying(100) NOT NULL, "module_name" character varying(255) NOT NULL, "module_score" numeric(5,2) NOT NULL DEFAULT '0', "status" character varying(30), "completed_count" integer NOT NULL DEFAULT '0', "incomplete_count" integer NOT NULL DEFAULT '0', "overdue_count" integer NOT NULL DEFAULT '0', "evidence_count" integer NOT NULL DEFAULT '0', "total_count" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_a64b321647cc3af607a1e783cfb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_de2c4df52fc3a70b075995a086" ON "module_scores" ("score_snapshot_id", "module_code") `);
        await queryRunner.query(`ALTER TABLE "issues" ADD "is_readiness_gap" boolean NOT NULL DEFAULT false`);
        await queryRunner.query(`ALTER TABLE "issues" ADD "source_module" character varying(100)`);
        await queryRunner.query(`ALTER TABLE "issues" ADD "region_id" uuid`);
        await queryRunner.query(`ALTER TABLE "issues" ADD "province_code" character varying(20)`);
        await queryRunner.query(`ALTER TABLE "issues" ADD "methodology_version_id" uuid`);
        await queryRunner.query(`ALTER TABLE "business_units" ADD "region_id" uuid`);
        await queryRunner.query(`ALTER TABLE "business_units" ADD "province_code" character varying(20)`);
        await queryRunner.query(`ALTER TABLE "business_units" ADD "profile_level" character varying(30)`);
        await queryRunner.query(`ALTER TABLE "action_plans" ADD "source_module" character varying(100)`);
        await queryRunner.query(`ALTER TABLE "action_plans" ADD "business_unit_id" uuid`);
    }
