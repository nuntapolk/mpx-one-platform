...
import { RopaFieldConfigModule } from './modules/ropa-field-config/ropa-field-config.module'
...
const ALL_ENTITIES = [
  ...
  AccessReview, WorkflowTemplate, WorkflowInstance, RopaFieldConfig, AppUser,
  // Legacy
