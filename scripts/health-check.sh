...
check "Public · Rights"   "$API/api/v1/public/rights/default"
check "Access Review"     "$API/api/v1/access-reviews"
check "Workflow"          "$API/api/v1/workflows"
check "ROPA Field Config" "$API/api/v1/ropa-field-configs"
check "EA Capabilities"   "$API/api/v1/ea-capabilities/summary"
check "ARB"               "$API/api/v1/arb/dashboard"
check "App Analytics"     "$API/api/v1/applications/analytics"
check "Access Logs"       "$API/api/v1/access-logs"
check "Accounts"          "$API/api/v1/accounts"
...
check "Portal · Rights"   "$WEB/portal/rights/default"
check "Access Review"     "$WEB/pdpa/access-review"
check "Workflow"          "$WEB/pdpa/workflow"
check "Master Data"       "$WEB/pdpa/master-data"
check "EA Capabilities"   "$WEB/ea/capabilities"
check "ARB"               "$WEB/ea/arb"
check "Account Mgmt"      "$WEB/accounts"
check "Auth · session"    "$WEB/api/auth/me"
check "Auth · proxy"      "$WEB/api/proxy/api/v1/ropa"
check "Login page"        "$WEB/login"
